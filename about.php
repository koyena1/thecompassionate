...
<php lang="en">
  <head>
    <title>About The Compassionate Space</title>
    <meta charset="utf-8">
...
?>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg-5.jpg');" data-stellar-background-ratio="0.5">
