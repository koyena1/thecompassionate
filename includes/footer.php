<footer class="ftco-footer">
        ...
        <div class="row mb-5">
          <div class="col-sm-12 col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2 logo"><a href="index.php">The Compassionate Space</a></h2>
          ...
          <div class="col-sm-12 col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="pricing.php"><span class="fa fa-chevron-right mr-2"></span>Plans &amp; Pricing</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-12 col-md">
    ...
    Copyright &copy;<script>document.write(new Date().getFullYear());</script> TheCompassionateSpace. All rights reserved  </i>
    </p>
            </div>
          </div>
        </div>
